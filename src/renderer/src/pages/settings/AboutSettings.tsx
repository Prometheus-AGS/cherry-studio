...
const AboutSettings: FC = () => {
  ...
  const onOpenDocs = () => {
    ...
    window.api.openWebsite(
      isChinese ? 'https://docs.prometheusags.ai/' : 'https://docs.prometheusags.ai/prometheus-studio-docs/en-us'
    )
  }
      ...
      <SettingGroup theme={theme}>
        <SettingTitle>
          ...
          <HStack alignItems="center">
            <Link to="https://github.com/Prometheus-AGS/prometheus-studio">
        ...
        <AboutHeader>
          <Row align="middle">
            <AvatarWrapper onClick={() => onOpenWebsite('https://github.com/Prometheus-AGS/prometheus-studio')}>
            ...
            <VersionWrapper>
              ...
              <Tag
                onClick={() => onOpenWebsite('https://github.com/Prometheus-AGS/prometheus-studio/releases')}
                color="cyan"
